...
//    void GetCylinder1(const Body **body, pgd::Vector3 pos, double *radius, pgd::Quaternion q) const;
//    void GetCylinder2(const Body **body, pgd::Vector3 pos, double *radius, pgd::Quaternion q) const;
