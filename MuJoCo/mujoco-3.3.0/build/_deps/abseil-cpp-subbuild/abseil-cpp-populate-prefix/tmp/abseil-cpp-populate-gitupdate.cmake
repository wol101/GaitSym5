...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "9ac7062b1860d895fb5a8cbf58c3e9ef8f674b5f"
  WORKING_DIRECTORY "/home/wis/Unix/git/GaitSym5/MuJoCo/mujoco-3.3.0/build/_deps/abseil-cpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/wis/Unix/git/GaitSym5/MuJoCo/mujoco-3.3.0/build/_deps/abseil-cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/wis/Unix/git/GaitSym5/MuJoCo/mujoco-3.3.0/build/_deps/abseil-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
